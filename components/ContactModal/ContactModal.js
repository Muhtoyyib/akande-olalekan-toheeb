...
const ContactModal = ({ handleModal }) => {
  return (
    <div
      className="md:w-[50%] w-full absolute right-0 top-0 h-screen bg-[var(--background)] border-l border-l-[var(--background)] z-20 px-10 py-10"
      data-aos="fade-left"
    >
      {/* Header */}
      <div className="flex justify-between items-center text-[20px] mb-10">
